...
| Data di fine pubblicazione | sì per pubblicare | metadato | calcolata dalla durata configurata per il tipo, che è il caso ordinario; il sistema rifiuta la **pubblicazione** senza, non il salvataggio della bozza. Dove la durata è **scelta dall'ente** e non prescritta da una norma, chi pubblica può indicarne una più breve sul singolo atto **prima** di pubblicarlo, con motivazione registrata: come rappresentare l'origine della durata è una decisione aperta al 2026-09-22, quindi il calcolo automatico non è l'unica strada. **Una defissione anticipata la riporta indietro**, ed è così, e non cambiando stato, che l'atto esce dalla vista |
