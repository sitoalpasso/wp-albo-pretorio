...
| # | Stato | Il test, in parole | Esito atteso |
|---|---|---|---|
| A-11 | fatto | Si registra il tipo attraverso il meccanismo comune **senza che la sezione sia registrata** | rifiutato con il codice di errore dedicato, e il tipo **non risulta fra quelli di WordPress**: la verifica rilegge, non assume |
